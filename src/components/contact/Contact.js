        ...
        >
            ...
            <div className="w-full">
                <div className="w-full h-auto flex flex-col mdl:flex-row lg:flex-row md:flex-row xl:flex-row lgl:flex-row justify-between">
                    ...
                    <div className="w-[100%] lgl:w-[60%] lg:w-[60%] xl:w-[60%] mdl:w-[60%]  h-full py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne">
