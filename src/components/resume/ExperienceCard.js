...
const ExperienceCard = ({ position, company, experienceTime, about, technology, project }) => {
    return (
        <div className="w-full h-1/3 group flex">
            ...
            <div className="w-full py-8 bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne">
                <div className="flex flex-row lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
                    ...
                    <div>
                        {
                            experienceTime && <p className="  px-4 py-2 text-designColor bg-black bg-opacity-25 rounded-lg flex justify-center items-center shadow-shadowOne text-sm font-medium">
                                {experienceTime}
                            </p>
                        }
                    </div>
