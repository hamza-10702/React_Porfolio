...
import { bannerImage2_png } from "../../assets/index";
const Banner = ({ data }) => {
    ...
    >
      <div className="w-full lgl:w-1/2 lg:w-1/2 xl:w-1/2 flex flex-col gap-14 pt-20">
        <div className="flex flex-col gap-4">
          <h4 className="text-lg font-normal uppercase">WELCOME</h4>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <span className="bannerIcon">
                <a href={`mailto:${data?.contact[0]?.contactLink}`}>
                  <FaGoogle />
                </a>
              </span>
              <span className="bannerIcon">
                <a href={`${data?.contact[1]?.contactLink}`}>
                  <FaLinkedin />
                </a>
              </span>
              <span className="bannerIcon">
                <a href={`${data?.contact[2]?.contactLink}`}>
                  <BsGithub />
                </a>
              </span>
            </div>
      ...
      <div className="hidden xl:block lgl:block  lg:block w-1/2 flex justify-center items-center relative">
        <img
          ...
          src={data?.bannerImage ? data?.bannerImage : bannerImage2_png}
          alt="Image"
        />
      </div>
      {error && (
